...
class Dataset():
    ...
    def __init__(self, dataset_name, cam_intri, DEBUG=False):
        ...
        if dataset_name == 'train':
            ...
            self.path = os.path.join(SYSTEM_PATH, "datasets/ycb/dataset_config/real_data_list.txt") #####
            #self.path = '/home/barry/cxg/pose_estimation/FFB6D/ffb6d/datasets/ycb/dataset_config/real_data_list.txt' #####
            self.all_lst = bs_utils.read_lines(self.path) # [file1, file2, ...]
    ...
    def get_item(self, item_name):
        ...
        cls_id_lst = meta['obj_id'].flatten().astype(np.uint32)
