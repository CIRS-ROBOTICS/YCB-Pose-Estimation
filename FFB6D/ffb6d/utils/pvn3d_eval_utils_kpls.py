...
def cal_frame_poses(
    ...
    pred_ctr = pcld - ctr_of[0] # get the predictived central point
    pred_kp = pcld.view(1, n_pts, 3).repeat(n_kps, 1, 1) - pred_kp_of # get the key point
    ...
    ############### adding new code #############################
    ori_rgb2 = ori_rgb.copy()
    full_mask = full_mask.flatten()
    mask = full_mask[choose]
    ...
    for icls, cls_id in enumerate(pred_cls_ids):
        ...
        # visualize
        if debug:
            show_kp_img2 = ori_rgb2.copy() # optional variable
            ...
            # show_kp_img2 = bs_utils.draw_p2ds(show_kp_img2, kp_2ds, r=3, color=color) # optional visualization
